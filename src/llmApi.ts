...
export async function generateSwarmWithAI(prompt: string): Promise<any> {
  try {
...
export async function generateToolWithAI(prompt: string): Promise<any> {
  try {
    const response = await getAIResponse(prompt);
...
export async function generateAgentWithAI(prompt: string): Promise<any> {
  try {
    const response = await getAIResponse(prompt);
...
export async function generateSuggestions(context: string, currentSwarm: string): Promise<string[]> {
  try {
